...
<?php require ('fheader.php');  ?>
 ...
 <script>
  window.addEventListener("load", function() {
    const endpoint = "https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=ffeaac5affe14f6d846755204413b5f0";
    fetch(endpoint)
    .then(response => {
      if (!response.ok) {
...
<div class="container-fluid ">
	...
	error_reporting(E_ERROR | E_PARSE);
	       ...
	       // https://newsapi.org/v2/everything?q=Agriculture&sortBy=popularity&apiKey=ffeaac5affe14f6d846755204413b5f0
	
        $url="https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=ffeaac5affe14f6d846755204413b5f0";   //Your API KEY
