      ...
      <div class="container ">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Farmers can get recommendations for crops and even 
          ...
          <div class="col-lg-6">
            ...
            <div class="info info-horizontal info-hover-warning mt-5">
              <div class="description pl-4">
                ...
                <p class=" ">Customers can buy crops directly from the farmers without the involvement of any middlemen based on availability.</p>
              </div>
            </div>
